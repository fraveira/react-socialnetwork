...
app.post("/register", (req, res) => {
    ...
    bcrypt.hash(password).then(hash => {
        db.registeringUsers(first_name, last_name, email, hash)
            .then(({ rows }) => {
            ...
            .catch(err => {
                console.log(
                    "error happened, maybe user typed an existing-email.",
                    err
                );
            });
    });
...
app.post("/login", (req, res) => {
    ...
    db.retrievingPassword(email)
        ...
        .catch(error => {
            console.log(
                "This is catching an error happening in comparing passwords",
                error
            );
            res.json({ success: false });
        });
